...
B) `B-mcq-generator.prompt.md` → generate MCQs with 1 correct + 1 absurd + 2 deceptive
C) `C-open-answer-evaluator.prompt.md` → evaluate an open answer with a 0–5 rubric
