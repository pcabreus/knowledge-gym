...
- [Microservices Pattern Combinations](architecture/microservices-pattern-combinations.md)
...
- [API Composition](architecture/api-composition.md)
- [Database per Service](architecture/database-per-service.md)
- [Anti-Corruption Layer (ACL)](architecture/anti-corruption-layer.md)
- [Strangler Fig Pattern](architecture/strangler-fig.md)
...
- [TCP](operations/tcp.md)
- [UDP](operations/udp.md)
...
- [Service Level Indicator (SLI)](operations/service-level-indicator.md)
- [Service Level Objective (SLO)](operations/service-level-objective.md)
- [Service Level Agreement (SLA)](operations/service-level-agreement.md)
- [Error budgets](operations/error-budgets.md)
- [Retry budgets](operations/retry-budgets.md)
- [Adaptive concurrency](operations/adaptive-concurrency.md)
- [Request hedging](operations/request-hedging.md)
